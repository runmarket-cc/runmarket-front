...
import { ArrowLeft, Loader2, Pencil, Trash2, MapPin, Calendar, Clock, Phone, Mail, Globe, Building2, User, Heart } from 'lucide-react'
...
import { isLoggedIn, isUserLoggedIn } from '@/lib/auth'
...
export default function RaceDetailPage() {
  ...
  const handleLike = async () => {
    ...
    try {
      const res = nextLiked ? await api.likeRace(id) : await api.unlikeRace(id)
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <button
                ...
                className={cn(
                  'flex items-center gap-1.5 rounded-md border px-3 py-1.5 text-sm font-medium transition-colors disabled:opacity-60 disabled:cursor-not-allowed',
                  liked
